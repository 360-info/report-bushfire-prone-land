...
description: What percentage of your suburb is at risk?
format:
...
twitter-card:
  site: "@360info_global"
  image: "https://dec2023-news.360info-bushfire-prone-land.pages.dev/map/bpa-map-banner.png"
open-graph:
  image: "https://dec2023-news.360info-bushfire-prone-land.pages.dev/map/bpa-map-banner.png"
resources:
  - bpa-map-banner.png
...
360embed:
  before: |
    ...
    &lt;iframe allow=&quot;fullscreen; clipboard-write self https://dec2023-news.360info-bushfire-prone-land.pages.dev&quot; allowfullscreen=&quot;true&quot; src=&quot;
  url: https://dec2023-news.360info-bushfire-prone-land.pages.dev/map/
  after: |
...
// initial bounds
initBounds = ({
  "NSW": [[146.0, -38.0], [154.0, -28.0]],
  "VIC": [[140.0, -39.0], [150.0,-33.0]],
  "QLD": [[142.0, -35.0], [159.0, -15.0]],
  "SA":  [[131.0, -40.0], [144.0, -27.0]],
  "WA":  [[108.5, -42.0], [125.5, -20.0]],
  "TAS": [[143.0, -43.0], [149.0, -38.0]],
  "NT":  [[128.0, -22.0], [138.0, -6.0]],
  ...
  map.on("load", () => {
    ...
    map.on("click", "suburbs-colors", function(e) {
      ...
      var dataMessage =
        ...
        "(about " + bfArea + " sq. km) " +
        "is classified as " + terms[selectedState] + "</p>"
...
terms = ({
  "NSW": "a Bushfire Prone Area",
  "VIC": "a Bushfire Prone Area",
  "QLD": "a Bushfire Prone Area",
  "SA":  "a Bushfire Protection Area",
  "WA":  "a Bushfire Prone Area",
  "TAS": "a Bushfire Prone Area",
  "NT":  "Fire Protection Zone",
  "ACT": "Bushfire Prone Area"
})

html`<p style="font-size: 125%"><strong>${selectedSuburbPercent}</strong> of ${selectedSuburbName} (about ${selectedSuburbArea} sq. km) is classified as ${terms[selectedState]}.</p>`
```
